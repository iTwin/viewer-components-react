...
import type { MappingsClient, MappingSingle, ReportMappingCollection, ReportsClient } from "@itwin/insights-client";
...
const mockMappingsFactory = (mockReportMappings: ReportMappingCollection): MappingSingle[] => {
  const mockMappings: MappingSingle[] = mockReportMappings.mappings.map((mapping, index) => ({
    mapping: {
