...
describe("Widget Header Component", function () {
  it("should have hello as title", function () {
    ...
    expect(container.firstChild).toHaveClass("e_c_3-widget-header-container");
    expect(container.firstChild?.firstChild).toHaveClass("e_c_3-title");
  });
  ...
  it("with return function", function () {
    ...
    expect(container.firstChild?.firstChild).toHaveClass("e_c_3-chevron");
    expect(container.firstChild?.firstChild).not.toHaveClass(
      "e_c_3-chevron-disabled"
    );
  });
  ...
  it("with disabled", function () {
    ...
    expect(container.firstChild?.firstChild).not.toHaveClass("e_c_3-chevron");
