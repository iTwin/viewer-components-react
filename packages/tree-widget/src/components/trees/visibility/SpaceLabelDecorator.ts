...
// import { TextOffsetProps, TextOffsetType, TextStyleProps } from "@bentley/measure-tools";
import { TextOffsetProps, TextOffsetType, TextStyleProps } from "../MeasureTools/GraphicStyle";
