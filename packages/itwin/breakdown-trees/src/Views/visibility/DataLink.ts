...
export class DataLink {
  public static queryAllBuildings(iModel: IModelConnection) {
  ...
  public static queryAllStories(iModel: IModelConnection) {
  ...
  public static queryStoriesWithRooms(iModel: IModelConnection) {
  ...
  public static queryStoryRange(iModel: IModelConnection, storyId: string, clipAtSpaces: boolean): Promise<Range3d | undefined> {
  ...
  public static queryRooms(iModel: IModelConnection, storyId?: string) {
  ...
  public static querySpatialIndex(iModel: IModelConnection, elementId: string) {
    const query = `SELECT ECInstanceId FROM biscore.spatialIndex where ECInstanceId = ${elementId}`;

    return this.executeQuery(iModel, query);
  }

  public static queryChildWithGeometry(iModel: IModelConnection, elementId: string) {
