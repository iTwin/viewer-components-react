...
export const testCases: QueryBuilderTestData = {
  testCases: [
    ...
    },
    {
      ...
      expectedResult:
        "SELECT BisCore.B.ECInstanceId, BisCore.B.ECClassId FROM BisCore.B JOIN mockModeledElement ON mockModeledElement.UserLabel = 'displayValueString' OR mockModeledElement.CodeValue = 'displayValueString' WHERE mockModeledElement.ECInstanceId = BisCore.Element.Model.id",
      operations: [
        {
          expectedResult: true,
          operationType: "addProperty",
