...
import { BuildingClipPlanesProvider } from "../../components/trees/FunctionalityProviders";
...
describe("BuildingClipPlanesProvider", () => {
  ...
  before(async () => {
    ...
    createRange3DPlaneStub = sinon.stub(ConvexClipPlaneSet, "createRange3dPlanes" as any).returns(moq.It.isAny());
  });
  after(() => {
