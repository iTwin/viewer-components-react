...
// cspell:words nycrc pnpmfile mocharc npmignore
...
const ignore = ["node_modules", ".git", "lib", "dist", "e2e-out", ".nyc_output", "mocharc", "npmignore", "pnpmfile", "nycrc", ".config.", ".oxfmtrc.json"];
