...
//       const result = await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
...
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
//       const result = await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
//       expect(result).to.deep.eq([[modelId, categoryId, elementId]]);
...
//       const result2 = await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
//       expect(result2).to.deep.eq([[modelId, categoryId, elementId]]);
//       expect(vp.iModel.createQueryReader).to.be.calledOnce;
//     });
...
//       const resultPromise2 = firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
...
//       using info = new AlwaysAndNeverDrawnElementInfo(vp);
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
//       await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: ["0x2"] }));
//       expect(vp.iModel.createQueryReader).to.be.calledOnce;
//       const resultPromise2 = firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: ["0x2"] }));
//       const setterFunction = setType === "always" ? vp.setAlwaysDrawn : vp.setNeverDrawn;
...
//       using info = new AlwaysAndNeverDrawnElementInfo(vp);
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
//       const result1 = await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
//       expect(result1).to.deep.eq([[modelId, categoryId, elementId]]);
//       expect(vp.iModel.createQueryReader).to.be.calledOnce;
...
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
//       await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId] }));
//       expect(vp.iModel.createQueryReader).to.be.calledOnce;
//       expect(result1).to.deep.eq([[modelId, categoryId, elementId]]);
//       info.resumeChangeEvents();
...
//       using info = new AlwaysAndNeverDrawnElementInfo(viewport);
//       await sinon.clock.tickAsync(SET_CHANGE_DEBOUNCE_TIME);
//       const result = await firstValueFrom(info.getElementPaths({ setType, parentInstanceNodeIds: [modelId, categoryId] }));
//       expect(result).to.deep.eq([[modelId, categoryId, elementId]]);
//     });
