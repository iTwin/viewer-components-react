...
const {
    FrontendDefaultsPlugin,
    IModeljsLibraryImportsPlugin,
...
const srcFile = path.join(__dirname, 'src', 'grouping-mapping-widget.ts');
...
module.exports = function () {
    ...
    const rawConfig = {
        ...
        output: {
            ...
            library: 'reporting-mapping-widget',
            libraryTarget: 'umd',
            umdNamedDefine: true,
        ...
        module: {
            ...
            rules: [
                ...
                // { parser: { requireEnsure: false } },
                {
                    ...
                    oneOf: [
                        // Reporting Change: Support SVG Icons
                        {
                            test: /\.svg$/,
                            issuer: /\.[jt]sx?$/,
                            include: [
                                path.resolve(__dirname, 'src/widget/icons'),
                            ],
                            loader: '@svgr/webpack',
                            options: {
        ...
        // Reporting Change: Exclude React as it is a peer dependency.
        externals: {
            react: {
                root: 'React',
                commonjs2: 'react',
