...
import { createTreeWidgetViewport, TreeWidgetViewport } from "../../tree-widget-react/components/trees/common/TreeWidgetViewport.js";
...
export function createTreeWidgetTestingViewport(viewport: Viewport): TreeWidgetTestingViewport {
  ...
  return {
    addViewedModels: (props) => treeWidgetViewport.addViewedModels(props),
    iModel: treeWidgetViewport.iModel,
    get alwaysDrawn() { return treeWidgetViewport.alwaysDrawn },
    get neverDrawn() { return treeWidgetViewport.neverDrawn },
    get viewType() { return treeWidgetViewport.viewType },
    get isAlwaysDrawnExclusive() { return treeWidgetViewport.isAlwaysDrawnExclusive },
    ...
    get onAlwaysDrawnChanged() { return treeWidgetViewport.onAlwaysDrawnChanged },
    get onDisplayedCategoriesChanged() { return treeWidgetViewport.onDisplayedCategoriesChanged },
    get onDisplayedModelsChanged() { return treeWidgetViewport.onDisplayedModelsChanged },
    get onNeverDrawnChanged() { return treeWidgetViewport.onNeverDrawnChanged },
    get onDisplayStyleChanged() { return treeWidgetViewport.onDisplayStyleChanged },
    get onPerModelCategoriesOverridesChanged() { return treeWidgetViewport.onPerModelCategoriesOverridesChanged },
    get perModelCategoryOverrides() { return treeWidgetViewport.perModelCategoryOverrides },
