...
An example of group custom UI provider, [ManualUIComponent](./src/widget/components/provider/ManualUIComponent.tsx) helps user to manually define ECSQL query for groups.
