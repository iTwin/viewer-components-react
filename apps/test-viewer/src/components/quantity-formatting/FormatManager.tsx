  ...
  public async onIModelOpen(iModel: IModelConnection): Promise<void> {
    ...
    try {
      const schemaFormatSet: FormatSet = {
        ...
        description: "This format set was automatically created based on the data in the opened iModel. It provides formatting for all quantities used in the model.",
        formats: {},
      };
