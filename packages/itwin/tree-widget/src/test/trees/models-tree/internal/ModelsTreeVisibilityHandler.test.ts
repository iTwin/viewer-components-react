...
//           await handler.changeVisibility(createSubjectHierarchyNode(), "visible");
...
//             await handler.changeVisibility(node, "hidden");
...
//           await handler.changeVisibility(createCategoryHierarchyNode("0x1"), "visible");
...
//           await handler.changeVisibility(createElementHierarchyNode({ modelId, categoryId, elementId }), "visible");
...
//             await handler.changeVisibility(createElementHierarchyNode({ modelId, categoryId, hasChildren: true, elementId }), "visible");
//             expect(viewport.neverDrawn?.size ?? 0).to.eq(0);
//           });
//         });
...
//         //   for (const on of ["visible", "hidden"]) {
...
//         function testChildElementsChange(on: "visible" | "hidden") {
...
//         testChildElementsChange("visible");
//         testChildElementsChange("hidden");
//       });
//     });
//   });
...
//       const { handler, provider, viewport } = visibilityTestData;
//       await using(handler, async (_) => {
//         await handler.changeVisibility(createSubjectHierarchyNode(IModel.rootSubjectId), "visible");
//         await validateHierarchyVisibility({
//           provider,
//           handler,
//           viewport,
...
//       const { handler, provider, viewport } = visibilityTestData;
//       await using(handler, async (_) => {
//         await handler.changeVisibility(createModelHierarchyNode(ids.model), "visible");
...
//         await handler.changeVisibility(createModelHierarchyNode(ids.model), "visible");
//         viewport.renderFrame();
//         await handler.changeVisibility(createElementHierarchyNode({ modelId: ids.model, categoryId: ids.category, elementId: ids.parentElement }), "hidden");
//         viewport.renderFrame();
...
//       const { handler, provider, viewport } = visibilityTestData;
//       await using(handler, async (_) => {
//         await handler.changeVisibility(createElementHierarchyNode({ modelId: ids.model, categoryId: ids.category, elementId: ids.elementToShow }), "visible");
//         viewport.renderFrame();
...
//         await handler.changeVisibility(createElementHierarchyNode({ modelId: ids.model, categoryId: ids.category, elementId: elementToShow }), "visible");
//         viewport.renderFrame();
...
//       const { handler, provider, viewport } = visibilityTestData;
//       await using(handler, async (_) => {
//         await handler.changeVisibility(createSubjectHierarchyNode("0x1"), "visible");
...
//       const { handler, provider, viewport } = visibilityTestData;
//       await using(handler, async (_) => {
//         await handler.changeVisibility(createCategoryHierarchyNode(ids.model, ids.category), "visible");
//         viewport.renderFrame();
//         await validateHierarchyVisibility({
//           provider,
//           handler,
...
//         await handler.changeVisibility(createCategoryHierarchyNode(ids.model, ids.category), "hidden");
//         viewport.renderFrame();
...
//         await using(handler, async (_) => {
//           await handler.changeVisibility(parentCategoryNode, "visible");
//           viewport.renderFrame();
//           await validateHierarchyVisibility({
//             ...props,
//             handler,
...
//         await using(handler, async (_) => {
//           await handler.changeVisibility(elementNode, "visible");
//           viewport.renderFrame();
//           await validateHierarchyVisibility({
//             ...testProps,
//             handler,
...
//           await using(handler, async (_) => {
//             await handler.changeVisibility(createModelHierarchyNode(emptyModelId), "visible");
//             await validateHierarchyVisibility({
//               provider,
//               handler,
//               viewport,
...
//           await using(handler, async (_) => {
//             await handler.changeVisibility(createModelHierarchyNode(configurationModelId), "visible");
//             await validateHierarchyVisibility({
//               provider,
//               handler,
//               viewport,
