...
export function MapLayerSettingsMenu({ mapLayerSettings, onMenuItemSelection, activeViewport, disabled }: MapLayerSettingsMenuProps) {
  ...
  return (
    <>
      <DropdownMenu menuItems={dropdownMenuItems} disabled={disabled} data-testid="map-layer-settings"  >
        <IconButton aria-label='More options' size="small" styleType="borderless">
          <SvgMoreVertical />
        </IconButton>
      </DropdownMenu>
    </>
